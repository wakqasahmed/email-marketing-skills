...
description: Route email-marketing work by recipient jurisdiction before drafting, with operational checkpoints for the US, UK, EEA, Canada, and unresolved locations.
version: 1.0.0
...
- **Canada:** Treat commercial electronic messages as a CASL routing case: document the consent relied on, sender identification, and unsubscribe mechanism before proceeding; refer uncertain consent or exemption questions to qualified counsel. [CRTC-CASL-01][CRTC-CASL-02]
...
3. Selected routing path: US, UK, EEA, Canada, or unknown/conflicting.
